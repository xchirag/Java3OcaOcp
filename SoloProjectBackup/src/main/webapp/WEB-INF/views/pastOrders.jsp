...
<title>This page lists your past orders</title>
<style>
table {
...
<table id="listTables">
		<c:if test="${count == 0}">
			<tr>
				...
				<td><c:out value="Basket Price you Paid (£)" />
				<td><c:out value="Discount(%)" />
				<td><c:out value="Discounted Price" /> 
				<c:set var="count" value="1" />
			</tr>
		</c:if>
		<c:forEach var="eachBasket" items="${listBasketToJsp}">
			<tr>
	...
	<h4 class="w3-xlarge">Other Options</h4>
