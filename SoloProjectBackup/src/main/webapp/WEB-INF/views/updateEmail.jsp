...
<div class="mainContainer"> 
	...
	<sf:form action="submitUpdateEmail" method="post"
			modelAttribute="user">
			...
			<sf:label path="homeAddress"> New Home Address:   </sf:label> <label> ${error3} </label>
			<sf:input path="homeAddress" size="30" value="" /> -->
 
			<sf:label path="emailAddress"> New Email Address:   </sf:label> <label> ${error1} </label>
			<sf:input path="emailAddress" size="30" value="" />
			
			<input type="submit" name="commit" value="Update Your Email" />
