...
<body>
	...
	<h4>Please deposit Money into your bank account to complete this order</h4>
	<h3 class="w3-xlarge">Your Current Bank Account Balance is (£) :
		${customerBankAccount.accountBalance}</h3>
	<br>
	<br>
	<h3 class="w3-xlarge">Current Basket Total is (£) :
		${checkOutTotal}</h3>
	<br>
	<br>

	<h3 class="w3-xlarge">You May require to deposit (£)
		${moneyMoreNeeded} to complete this Order</h3>
	<br>
	<br>
